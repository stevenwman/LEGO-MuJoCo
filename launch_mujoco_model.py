...
file_rel_path = "duplo_new/robot.urdf"
file_rel_path = "duplo_ballfeet/robot.urdf"
# file_rel_path = "duplo_mjcf/scene.xml"
...
mujoco.mj_saveLastXML("duplo_ballfeet_mjcf/duplo_output.xml", model)
